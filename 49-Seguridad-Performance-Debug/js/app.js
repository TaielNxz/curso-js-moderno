...
* No almacenar passwords en local storage
* el DOM Scripting ya escapa los datos y evita riesgos de seguridad, 
* utilizar Text content mayormente
* innerHTML cuando la fuente de datos sea segura

* validar en el Cliente (javascrip) para retroalimentacion en tiempo real
* validar en el servidor para seguridad
* autenticacion de usuarios ---> JWT y Auth0
* snyk.io para verificar vulnerabilidades
* Ofuscar
* Hashear informacion sensible con bcrypt
