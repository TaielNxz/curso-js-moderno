...
class UI {
    ...
    imprimirAlerta( mensaje , tipo ) {
        ...
        const existe = document.querySelector('.alert-existe');
        if( existe ) {
            existe.remove();
        }
        ...
        divMensaje.classList.add('text-center', 'alert', 'd-block', 'col-12', 'alert-existe');

        // Agregar clase en base al tipo del error
        if ( tipo === 'error' ) {
